@extends('layout.layout', ['page_title' => 'Inactive User Accounts'])
		...
		<div class="card">
			<div class="card-body">
				<div class="d-flex flex-column flex-lg-row justify-content-between">
					<h4 style="padding:5px 0px 35px;">Inactive User Accounts</h4>
				...
				<table class="table table-striped">
					...
					<tbody class="u-list">
						@if(count($data) == 0)
						<tr>
					    	<td colspan="7" style="padding:1rem .75rem;">No Inactive Users.</td>
					    </tr>
						@endif
...
function resultList(d, q){
	var data = {'q':q, 's':0,'_token':'{{csrf_token()}}'}, row;
    $.ajax({
        type:'POST',
        url:'/accounts/search',
		dataType: 'json',
