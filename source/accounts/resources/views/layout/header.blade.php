<header>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	  ...
	  <a class="navbar-brand" href="/"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> ACCOUNT MANAGER</a>
	    ...
	    <ul class="navbar-nav">
	    	...
	    	<li class="nav-item dropdown p-2">
	        	...
	        	<div class="dropdown-menu dropdown-menu-right" aria-labelledby="accountDropdown">
	        		<a class="dropdown-item" href="/accounts/all">Registered Accounts</a>
	        		<hr class="dropdown-divider">
	        		<a class="dropdown-item" href="/accounts/new"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a>
	        	</div>
	    	</li>
	    	<li class="nav-item dropdown p-2">
